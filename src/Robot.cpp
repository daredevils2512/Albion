...
std::shared_ptr<USBCamera> Robot::usbCamera;
std::shared_ptr<LHSVision> Robot::mLHSVision;
...
void Robot::RobotInit() {
	...
	mLHSVision.reset(new LHSVision());
	//usbCamera.reset(new USBCamera("cam1", true));
	...
	usbCamera = std::make_shared<USBCamera>("cam1", true);
	usbCamera->SetBrightness(5);
...
void Robot::TeleopPeriodic() {
	...
	Robot::visionTracking->ToggleCamera(Robot::shooter->GetPhotoeye());
	mLHSVision->UpdateVision(Robot::shooter->GetPhotoeye());
}
